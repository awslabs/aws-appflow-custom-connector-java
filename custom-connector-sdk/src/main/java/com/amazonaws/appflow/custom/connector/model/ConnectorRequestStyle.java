...
@Value.Style (
    ...
    isInitialized = "wasInitialized",  // Converting immutable internal method to avoid mapper deserialization issue
    create = "new",
    passAnnotations = {JsonTypeInfo.class, JsonTypeName.class},
    jdkOnly = true
)
