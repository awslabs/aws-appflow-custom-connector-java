...
/**
 * Represents the input of a <code>ValidateCredentials</code> operation.
 */
@ConnectorRequestStyle
@Value.Immutable
@JsonSerialize(as = ImmutableValidateCredentialsRequest.class)
@JsonDeserialize(as = ImmutableValidateCredentialsRequest.class)
@JsonTypeName("ValidateCredentialsRequest")
public interface ValidateCredentialsRequest extends ConnectorRequest {
    /**
