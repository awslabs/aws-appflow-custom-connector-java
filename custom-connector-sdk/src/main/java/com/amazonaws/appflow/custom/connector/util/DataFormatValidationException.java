...
/**
 * Exception that is thrown when the Data does not match the SDK format.
 */
public class DataFormatValidationException extends Exception {
    ...
    public DataFormatValidationException(final String message) {
        super(message);
    }

    public DataFormatValidationException(final String message, final Exception e) {
        super(message, e);
    }
}
