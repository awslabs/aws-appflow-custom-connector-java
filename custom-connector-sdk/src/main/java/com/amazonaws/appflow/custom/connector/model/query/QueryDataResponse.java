...
/**
 * Represents the output of a <code>QueryData</> operation.
 */
@Value.Immutable
@JsonSerialize(as = ImmutableQueryDataResponse.class)
@JsonDeserialize(as = ImmutableQueryDataResponse.class)
