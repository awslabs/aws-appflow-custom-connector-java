...
public class SalesForceQueryFilterExpressionVisitorTest {
    ...
    void testConversionFromFilterExpressionToSalesforceQuery(
            ...
            final String expectedSalesforceQueryExpression) {
        ...
        String actualQuery = result.getLeft();
        if (StringUtils.isNotBlank(result.getRight())) {
            actualQuery += "LIMIT " + result.getRight();
        }
        Assertions.assertEquals(expectedSalesforceQueryExpression, actualQuery);
    }

    private static Stream<Arguments> getTestFilterExpression() {
        return Stream.of(
                Arguments.of("Name = \"TestAccountName\"", "Name = 'TestAccountName' "),
                Arguments.of("Name = \"TestAccountName\" limit 100", "Name = 'TestAccountName' LIMIT 100 "),
                ...
                Arguments.of("CreatedDate > 2021-04-20T10:30:35Z AND AccountNumber = 40",
                             "CreatedDate > 2021-04-20T10:30:35ZAND AccountNumber = 40 "),
                ...
                Arguments.of(
                        ...
                        "AccountNumber > 100 and CreatedDate < 2021-04-20T12:30:45Zand CreatedDate > " +
                        "2021-04-21T15:45:49.234Zand Name LIKE '%TestAccountName%' "),
                Arguments.of(
                        ...
                        "AccountNumber > 100 and CreatedDate < 2021-04-20T12:30:45Zand CreatedDate > " +
                        "2021-04-21T15:45:49.234Zand Name LIKE '%TestAccountName%' LIMIT 100 "));
    }
