...
public class SalesForceQueryFilterExpressionVisitorTest {
    ...
    void testConversionFromFilterExpressionToSalesforceQuery(
        ...
        Assertions.assertTrue(expectedSalesforceQueryExpression.equals(
                salesForceQueryFilterExpressionVisitor.getResult()));
    }

    private static Stream<Arguments> getTestFilterExpression() {
        return Stream.of(Arguments.of("Name = \"TestAccountName\"", "Name = \'TestAccountName\' "),
                ...
                Arguments.of(
                        ...
                        "AccountNumber > 100 and CreatedDate < 2021-04-20T12:30:45Zand CreatedDate > 2021-04-21T15:45:49.234Zand Name LIKE \'%TestAccountName%\' "));
    }
